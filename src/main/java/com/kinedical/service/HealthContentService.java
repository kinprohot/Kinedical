...
public class HealthContentService {
    ...
    public void initializeDefaultArticles() {
        ...
        art1.setSummary(
                "Khám phá bí quyết dinh dưỡng từ chế độ ăn giàu dầu ô liu, cá, ngũ cốc nguyên hạt và rau quả tươi giúp bảo vệ hệ tim mạch.");
        art1.setBody(
                "Chế độ ăn Địa Trung Hải được các nhà khoa học đánh giá là một trong những lối sống lành mạnh nhất hành tinh. "
                        +
        ...
        art2.setSummary(
                "Các phương pháp tự nhiên và khoa học để duy trì chỉ số đường huyết ổn định, phòng ngừa các biến chứng nguy hiểm.");
        art2.setBody(
                "Bệnh tiểu đường tuýp 2 ngày càng phổ biến trong xã hội hiện đại. Để chung sống hòa bình với căn bệnh này, bệnh nhân cần điều chỉnh chế độ ăn uống khoa học, "
                        +
        ...
        art3.setSummary(
                "Tăng cường sức bền, cải thiện tuần hoàn máu và đốt cháy calo hiệu quả với các bài tập không cần dụng cụ chuyên dụng.");
        art3.setBody(
                "Tập luyện thể thao là nền tảng của một sức khỏe vàng. Với 5 bài tập Cardio đơn giản gồm Jumping Jacks, Burpees, Mountain Climbers, High Knees và squat jump, "
                        +
        ...
        art4.setSummary(
                "Luyện tập chánh niệm mỗi ngày giúp tâm trí bình yên, giảm lo âu và nâng cao hiệu suất làm việc.");
        art4.setBody(
                "Căng thẳng và áp lực từ cuộc sống hiện đại tàn phá thầm lặng hệ thần kinh của bạn. Thiền định và chánh niệm (Mindfulness) giúp bạn quay trở lại giây phút hiện tại, "
                        +
        ...
        art5.setSummary(
                "Vì sao chủ động tầm soát bệnh tật sớm là giải pháp bền vững bảo vệ chất lượng cuộc sống lâu dài.");
        art5.setBody(
                "Chủ động phòng bệnh hơn chữa bệnh. Nhiều căn bệnh âm thầm tiến triển mà không hề gây triệu chứng đau đớn ở giai đoạn khởi phát. "
                        +
